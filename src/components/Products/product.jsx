    ...
    return (
        <div className="product-container">
            <div className="product-image-container">
                <img className="product-page-image" src={(product.images != undefined && product.images.length > 0) ? product.images[selectedImage].secure_url : "http://localhost:5173/no_image.png"} alt="Product Image"></img>
